...
def cnn_model():
    ...
    x = Dropout(0.2)(x)
    x_out = Dense(2, activation='softmax')(x)  # Anzahl der Klassen anpassen
...
cnn.save('model1_cnn.h5', save_format='h5')

cnn = load_model('model1_cnn.h5')
...
ae.save('model1_cnn.h5', save_format='h5')

ae = load_model('model1_cnn.h5')
