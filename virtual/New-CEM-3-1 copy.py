...
last_image = x_test[-1].reshape(70, 70, 3)
plt.imshow(last_image)
plt.show()

index = -1  # Index des geladenen Bildes in x_test
image_path = data['path'].iloc[index]
print("Speicherort des geladenen Bildes: ", image_path)
